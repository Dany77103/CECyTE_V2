...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if (isset($_POST['preview'])) {
            ...
            header("Location: nuevo_alumno.php?preview=1");
            exit();
        }
        ...
        if (isset($_POST['guardar']) && empty($errores)) {
            try {
                ...
                if ($stmt->execute()) {
                    ...
                    header('Location: ver_alumno.php?matricula=' . urlencode($datos['matricula']));
                    exit();
            ...
            <div class="form-body">
                ...
                <form method="POST" action="" id="formAlumno">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="matricula" required 
                                       ...
                                       maxlength="11" pattern="[0-9]{7}" placeholder="11 d&iacute;gitos">
                    ...
                    <div class="d-flex justify-content-between mt-5 pt-3 border-top">
                        <a href="lista_alumnos.php" class="btn btn-cancel">
