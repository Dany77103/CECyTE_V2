    ...
    <div class="header-cecyte">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="lista_alumnos.php" class="btn btn-light">
            ...
            <div class="student-card-body">
                ...
                <form method="POST" action="" id="alumnoForm">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="lista_alumnos.php" class="btn btn-cecyte-secondary">
                            <i class='bx bx-arrow-back'></i> Volver a la Lista
                        </a>
                        <div>
                            <?php if ($modoEdicion && isset($alumno['matricula'])): ?>
                                <a href="ver_alumno.php?matricula=<?php echo urlencode($alumno['matricula']); ?>" class="btn btn-cecyte me-2" style="background: linear-gradient(135deg, var(--verde-claro), var(--verde-medio));">
                                    <i class='bx bx-show'></i> Ver Alumno
                                </a>
                                <a href="qr_alumno.php?matricula=<?php echo urlencode($alumno['matricula']); ?>" class="btn btn-cecyte me-2" style="background: linear-gradient(135deg, #ff9800, #ffb74d);">
