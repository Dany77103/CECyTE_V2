...
if (!isset($_GET['numEmpleado'])) {
    header('Location: lista_maestros.php?error=numEmpleado_invalida');
    exit();
}
    ...
    <div class="header-cecyte">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="lista_maestros.php" class="btn btn-light">
        ...
        <?php elseif ($maestro): ?>
            ...
            <div class="teacher-card">
                <div class="teacher-card-header">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <div class="btn-group">
                            <a href="editar_maestro.php?id=<?php echo urlencode($maestro['id_maestro']); ?>" 
                               class="btn btn-light">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="qr-container mt-4">
                                ...
                                <a href="qr_maestro.php?id=<?php echo urlencode($maestro['id_maestro']); ?>" 
            ...
            <div class="d-flex justify-content-between mt-4 mb-5 flex-wrap gap-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="eliminar_maestro.php?id=<?php echo urlencode($maestro['id_maestro']); ?>" 
