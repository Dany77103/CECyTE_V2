...
function obtenerDatos($query) {
    global $con; // Usamos la variable $con (conexi�n PDO)
    try {
...
// 6. NUEVAS ESTAD�STICAS: DISCAPACIDAD
...
// 7. NUEVAS ESTAD�STICAS: DATOS LABORALES MAESTROS
...
// 8. NUEVAS ESTAD�STICAS: EDADES DE ALUMNOS
...
// 9. NUEVAS ESTAD�STICAS: ALUMNOS POR TURNO
...
// 10. NUEVAS ESTAD�STICAS: ESTADO CIVIL
...
// Preparar datos para nuevas gr�ficas
...
<head>
    ...
    <style>
        :root {
            ...
            --verde-oscuro: #1a5330;      /* Verde m�s oscuro */
        ...
        * {
        ...
        /* Estilos para el sistema de estad�sticas */
        .stats-container {
            padding: 30px;
        }
        ...
        /* Secci�n de estad�sticas especiales */
        ...
        /* Tarjetas de estad�sticas especiales */
        .special-stats-grid {
            display: grid;
        ...
        /* RESPONSIVE - CORRECCIONES IMPORTANTES */
        ...
        /* Clase para mostrar el sidebar en m�viles */
        .sidebar-overlay {
            display: none;
            position: fixed;
            top: 0;
        ...
        /* Bot�n para mostrar sidebar en m�viles */
        .mobile-menu-btn {
            display: none;
            position: fixed;
            top: 15px;
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="content-wrapper">
            ...
            <main class="stats-container">
                ...
                <!-- NUEVA SECCI�N: Estad�sticas Especiales -->
                    ...
                    <ul class="nav nav-tabs" id="statsTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="demografica-tab" data-bs-toggle="tab" data-bs-target="#demografica" type="button" role="tab">
                                <i class="fas fa-users me-2"></i>Demogr�fica
                            </button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="statsTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="general" role="tabpanel">
                            ...
                            <div class="charts-grid">
                                ...
                                <!-- Gr�fica 2: Distribuci�n por g�nero -->
                                <div class="chart-wrapper">
                                    <div class="chart-header">
                                ...
                                <!-- Nueva Gr�fica: Calificaciones por rango -->
                                <div class="chart-wrapper">
                                    <div class="chart-header">
                                ...
                                <!-- Nueva Gr�fica: Alumnos por semestre -->
                                <div class="chart-wrapper">
                                    <div class="chart-header">
                        ...
                        <div class="tab-pane fade" id="discapacidad" role="tabpanel">
                            ...
                            <!-- Gr�ficas de discapacidad -->
                            <div class="additional-charts-grid">
                                <!-- Gr�fica de tipos de discapacidad -->
                                <div class="chart-wrapper">
                                    <div class="chart-header">
                                ...
                                <div class="chart-wrapper">
                                    <div class="chart-header">
                                        <h5 class="chart-subtitle">Proporci�n de Alumnos con Discapacidad</h5>
                                    </div>
                                    <div class="chart-container">
                            ...
                            <div class="mt-4">
                                <h5 class="mb-3">Distribuci�n por Tipo de Discapacidad</h5>
                        ...
                        <div class="tab-pane fade" id="laboral" role="tabpanel">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <h5 class="mb-3">Distribuci�n por Contrato</h5>
                                    <div class="table-responsive">
                                        <table class="detailed-data-table">
                                            <thead>
                                                <tr>
                                ...
                                <div class="col-md-6">
                                    <h5 class="mb-3">Distribuci�n por Departamento</h5>
                                    <div class="table-responsive">
                                        <table class="detailed-data-table">
                                            <thead>
                                                <tr>
                        ...
                        <div class="tab-pane fade" id="demografica" role="tabpanel">
                            <h4 class="chart-title mb-4">Estad&iacute;sticas Demogr�ficas</h4>
                            
                            <!-- Resumen demogr�fico -->
                            <div class="summary-card demografica">
                                <h5 class="summary-card-title">
                                    <i class="fas fa-users"></i> Resumen Demogr�fico
                                </h5>
                                <ul class="summary-list">
                                    <li>
                            ...
                            <div class="additional-charts-grid">
                                ...
                                <!-- Gr�fica de g�nero maestros -->
                                <div class="chart-wrapper">
                                    <div class="chart-header">
                                        <h5 class="chart-subtitle">Maestros por G�nero</h5>
                                        <div class="chart-actions">
    ...
    <script>
        ...
        // Funci�n para inicializar todas las gr�ficas
        ...
        // Funci�n para inicializar gr�ficas de discapacidad
        ...
        // Funci�n para inicializar gr�ficas laborales
        ...
        // Funci�n para inicializar gr�ficas demogr�ficas
        ...
        // ===== FUNCIONES PARA CREAR GR�FICAS =====
        
        // Funci�n para crear gr�fica de estado
        ...
        // Funci�n para crear gr�fica de g�nero
        function crearGraficaGenero(type) {
            ...
            chartGenero = new Chart(ctx, {
                ...
                options: getChartOptions('Distribuci�n de Alumnos por G�nero')
            });
        }
        
        // Funci�n para crear gr�fica de grupos
        ...
        // Funci�n para crear gr�fica de asistencia
        ...
        // Funci�n para crear gr�fica de calificaciones por rango
        ...
        // Funci�n para crear gr�fica de semestres
        ...
        // Funci�n para crear gr�fica de discapacidad
        ...
        // Funci�n para crear gr�fica de proporci�n de discapacidad
        ...
        // Funci�n para crear gr�fica de contratos
        ...
        // Funci�n para crear gr�fica de departamentos
        ...
        // Funci�n para crear gr�fica de edades
        ...
        // Funci�n para crear gr�fica de turnos
        ...
        // Funci�n para crear gr�fica de estado civil
        ...
        // Funci�n para crear gr�fica de g�nero maestros
        function crearGraficaGeneroMaestros() {
            ...
            chartGeneroMaestros = new Chart(ctx, {
                ...
                options: getChartOptions('Maestros por G�nero')
            });
        }
        
        // Funci�n auxiliar para obtener opciones de gr�fica
        ...
        // Funci�n para descargar gr�fica
        ...
        // Funci�n para imprimir gr�fica
        function imprimirGrafica(chartId) {
            const canvas = document.getElementById(chartId);
            const win = window.open('');
            win.document.write('<html><head><title>Imprimir Gr�fica</title></head><body>');
        ...
        // ===== EVENT LISTENERS Y CONFIGURACI�N =====
        
        // Event listeners para cambio de tipo de gr�fica
        ...
        tabEls.forEach(tabEl => {
            tabEl.addEventListener('shown.bs.tab', function(event) {
                ...
                // Inicializar gr�ficas seg�n la pesta�a activa
                switch(targetId) {
                    case '#general':
                        inicializarGraficas();
                        break;
        ...
        // Inicializar gr�ficas al cargar la p�gina
        document.addEventListener('DOMContentLoaded', function() {
            // Inicializar gr�ficas generales
            inicializarGraficas();
            
            // Aplicar handleResize al cargar
            handleResize();
            
            // Animaci�n de las tarjetas de estad�sticas
            ...
            // Animaci�n de tarjetas especiales
            ...
            setInterval(() => {
                ...
                // Aqu� podr�as hacer una llamada AJAX para actualizar datos
            }, 300000);
        });
